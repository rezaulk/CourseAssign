        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    if (UserManager.IsInRole(user.Id, "EveningCoordinator"))
                    {
                        Session["RoleName"] = "EveningCoordinator";
                        return RedirectToAction("Index", "CoOrdinator");
                    }
                    else if (UserManager.IsInRole(user.Id, "MorningCoordinator")) {
                        Session["RoleName"] = "MorningCoordinator";
                        return RedirectToAction("Index", "CoOrdinator");
                    }
                    else if (UserManager.IsInRole(user.Id, "Teacher"))
                    {
                        ...
                        return RedirectToAction("TeacherProfile", "Teachers");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var prevTeacher = _context.Teachers.OrderByDescending(x => x.joiningDate);
